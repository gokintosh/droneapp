...
<header id="header">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg px-4">
        <div class="container-fluid">
            <a class="navbar-brand font-orbitron" href="index.html"> <img src="./assets/Logo.png"></a>
...
<body>
    <div class="wrapper">
        <div>
            <div>
                <h1>Drone Post Service</h1>
            </div>
            <div class="description"> Stop worrying about Your package!!!
                Choose Dron Post Service!!! Check capabilities of delivery drons. Test its speed. Trust its safety.</div>
            <br>
            <h1>Our motto:</h1>
            <br>
            <h4><u>Be swift, Be clever, Be Eco!</u></h4>
        </div>
        <br>
        <div>
            
            <h1>Also come and visit us:</h1>
        </div>
        
       
        <div>
            <iframe width="420" height="420" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=420&amp;height=420&amp;hl=en&amp;q=Luboszycka%201A%20Opole+(Company%20Localization)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='http://maps-generator.com/pl'>Maps-Generator.com</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=61b091de52a6ccafaf3570ef4b5099bc4d6ce0f9'></script>
        </div>
